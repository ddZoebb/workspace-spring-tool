...
public class SpringApplicationContextSetterInjectionAnnotationMain {
	...
	public static void main(String[] args) throws Exception {
		...
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext("2.bean_setter_injection_annotation.xml");
		System.out.println("----Spring Container초기화끝[ApplicationContext객체생성끝]");
		 ...
		 /*
		 * System.out.println("--기본형,String 데이터 setter injection"); Guest
		 * guest=(Guest)applicationContext.getBean("guest"); System.out.println(guest);
		 */
	}
