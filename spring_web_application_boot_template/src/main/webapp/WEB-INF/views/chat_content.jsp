...
<script src="js/chat_content.js"></script>
<link
				...
				<div class="card chat-app">
					<div id="plist" class="people-list">
						<div class="input-group">
							...
							<input type="text" class="form-control"  id="temp_user" placeholder="Search...">
							<button type="button" class="btn btn-default" id="btnConnect">SOCKET CONNECT</button>
						</div>
						...
						<div class="chat-header clearfix">
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="chat-about">
										<h6 class="m-b-0">"상대방"</h6>
										<button type="button" class="btn btn-default" id="btnCall">채팅 데이터 부르기</button>
