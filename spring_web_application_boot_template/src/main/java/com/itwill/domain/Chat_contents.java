...
public class Chat_contents {
	...
	public Chat_contents() {
		super();
	}

	public Chat_contents(Integer c_content_no, String c_content, String send_time, Integer c_read, String user_id,
			Integer c_room_no) {
		super();
